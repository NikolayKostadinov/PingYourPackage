        ...
        protected override void Seed(PingYourPackage.Domain.Entities.EntitiesContext context)
        {
            ...
            if (!context.Users.Any())
            {
                ...
                context.Users.AddOrUpdate(user => user.Key,
                    ...
                    {
                        Key = affiliateKeys[0],
                        Name = passList[2].Name,
                        Email = "companya@example.com",
                        Salt = passList[2].Salt,
                        HashedPassword = passList[2].Pass,
                        IsLocked = false,
                    ...
                    {
                        Key = affiliateKeys[1],
                        Name = passList[3].Name,
                        Email = "companyb@example.com",
                        Salt = passList[3].Salt,
                        HashedPassword = passList[3].Pass,
                        IsLocked = false,
                        CreatedOn = DateTime.Now,
                    ...
                    {
                        Key = affiliateKeys[2],
                        Name = passList[4].Name,
                        Email = "companyc@example.com",
                        Salt = passList[4].Salt,
                        HashedPassword = passList[4].Pass,
                        IsLocked = false,
                        CreatedOn = DateTime.Now,
